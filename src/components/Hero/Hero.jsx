      ...
      <Container className="flex flex-wrap pt-40 ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <h1 className="text-4xl font-bold leading-snug tracking-tight mt-5 text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight ">
              Find Event Managers
            </h1>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row mt-10">
              ...
              <Link
                to="/signup"
                className="px-8 py-4 text-lg font-medium text-center text-black border rounded-md "
              >
                Join as a Planner
              </Link>
            </div>
