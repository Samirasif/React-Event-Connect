...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle form submission logic here (e.g., sending the data to an API or backend)
                  ...
                  <div className="mx-0 mb-1 sm:mb-4">
                    <div className="mx-0 mb-1 sm:mb-4">
                      ...
                      <input
                        ...
                        className="mb-2 w-full -md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0 rounded"
                      />
                    </div>
                    <div className="mx-0 mb-1 sm:mb-4">
                      <label
